...
//
//	mockgen -source ./clock/clock.go -destination ./tests/mock/clock/clock.go
//
...
import (
	...
	clock "github.com/downsized-devs/sdk-go/clock"
...
func (m *MockInterface) GetTimeInLocation(locationParam clock.Location, timeParam time.Time) (time.Time, error) {
	m.ctrl.T.Helper()
