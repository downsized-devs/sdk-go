...
// Source: ./gqlclient/client.go
//
// Generated by this command:
//
//	mockgen -source ./gqlclient/client.go -destination ./tests/mock/gqlclient/client.go
//
...
func (m *MockInterface) Run(ctx context.Context, req *gqlclient.Request, resp any) error {
	m.ctrl.T.Helper()
...
func (mr *MockInterfaceMockRecorder) Run(ctx, req, resp any) *gomock.Call {
